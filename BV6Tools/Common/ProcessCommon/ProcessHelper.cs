...
{
    // Source - https://stackoverflow.com/a/63624152
    // Posted by Oz Solomon
    ...
    public static partial class ProcessHelper
    {
        ...
        public static Process? RunAsRestrictedUser(string fileName, string? args = null)
        {
            ...
            try
            {
                ...
                char[] cmdChars = new char[cmdStr.Length + 1];
                cmdStr.CopyTo(0, cmdChars, 0, cmdStr.Length);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        private static partial bool ConvertStringSidToSid(string StringSid, out IntPtr ptrSid);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        private static partial bool SaferCloseLevel(IntPtr hLevelHandle);

        [LibraryImport("advapi32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static partial bool SaferComputeTokenFromLevel(IntPtr LevelHandle, IntPtr InAccessToken, out IntPtr OutAccessToken, int dwFlags, IntPtr lpReserved);

        [LibraryImport("advapi32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static partial bool SaferCreateLevel(SaferScope scope, SaferLevel level, SaferOpenFlags openFlags, out IntPtr pLevelHandle, IntPtr lpReserved);
